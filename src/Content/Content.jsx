...
const [value_ii_offset] = useState(315 - (value_ii / 100) * 315)
  ...
  <div className="notifications">
   ...
   <svg
      ...
      <div className="row square"> <Analytics chart_i /></div>
         
      <div className="row square"> <Analytics chart_ii /></div>

      <div className="row square"><Analytics chart_iii /> </div>

      <div className="row square"> <Analytics title="Welcome to Maclab"/>
      </div>
      ...
      <div className="row tall-square">
       ...
       <div className="row tall-square inv-bg">
        ...
        <div className="info">
            ...
            <span className="admin-about"> Full-Stack & Content Creato</span>
        </div>
       ...
       <div className="row side-rect">
        ...
        <CircularProgress color= "#810551" value={value_i} offset={value_i_offset}/>
            ...
            <div className="summary">
                ...
                <span className="summary-info"> MacLab Security System is made by 3rd Year Students to
                help the school staff determined and monitor those student who entered the MacLaboratory Room</span>
            </div>
       ...
       <div className="row side-rect">
        <section>
            ...
            <span className="txt">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
              Repellendus consectetur dolore ea temporibus ducimus officiis hic
              ipsa reiciendis.</span>
            </div>
        </section>
       </div>
      <div className="row side-rect">
